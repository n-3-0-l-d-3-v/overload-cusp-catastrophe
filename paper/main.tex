...
executive difficulty with large effect sizes \cite{kiep2023,demetriou2018}, so
...
\cite{cano2024,chen2024ema}, so none are analysed here, and we say so rather
...
\begin{tabular}{@{}llrr@{}}
\toprule
Estimator & Detrend & Window & Median exponent \\
\midrule
theory $\lambda_{\text{rel}}(\mu)$ & n/a & n/a & $\mathbf{+0.565}$ \\
\midrule
$-\log$AC1 (predicted $+0.5$) & no  & 30  & $-0.262$ \\
$-\log$AC1 (predicted $+0.5$) & no  & 120 & $-0.035$ \\
variance (predicted $-0.5$)   & no  & 30  & $+0.311$ \\
variance (predicted $-0.5$)   & yes & 120 & $+0.036$ \\
\bottomrule
\end{tabular}
\end{table}
